                                ...
                                <div className="p-4 flex flex-col flex-grow">
                                    ...
                                    <div className="mt-auto pt-4 flex items-center gap-2">
                                        ...
                                        <button
                                            ...
                                            className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium rounded-lg bg-red-600 text-white hover:bg-red-700 transition"
                                        >
                                            Delete
                                        </button>
                                    </div>
